...
export function NavBar({ scroll = false }: NavBarProps) {
  ...
  return (
    ...
    >
      <MaxWidthWrapper className="flex h-14 items-center justify-between py-4" large={documentation}>
        ...
        <div className="flex items-center space-x-3">
          ...
          {session ? (
            <Link href={session.user.role === 'ADMIN' ? '/admin' : '/dashboard/topic'} className="hidden md:block">
